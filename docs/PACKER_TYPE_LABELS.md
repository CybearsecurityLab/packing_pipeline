...
*(manifest rows below: 112 typed / 2 unresolved across 114 keys; a condition named differently in packer_corpus.yaml and worklist.json appears under both, so that denominator is larger than the corpus.)*
