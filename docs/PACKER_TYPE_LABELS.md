...
**107 corpus definitions** · 100 typed · 7 untyped.  
*(manifest rows below: 107 typed / 7 unresolved across 114 keys; a condition named differently in packer_corpus.yaml and worklist.json appears under both, so that denominator is larger than the corpus.)*
...
|---|---|---|
| alushpacker | 1.0.0 | `infrastructure_guest_dependency_missing` |
...
| telock | 0.98 | `invalid_sample_not_packed` |
