...
**101 conditions** · 97 typed · 4 pipeline-unresolved.
...
| kkrunchy | 0.23_alpha_2 | KKRUNCHY_V023A2_001_DEFAULT | **TYPE_II** | empirical_family_version_inference |
...
| yoda_protector | 1.01.2 | . | **TYPE_IV** | empirical_family_version_inference |
| yoda_protector | 1.02 | . | **TYPE_IV** | exact |
| yoda_protector | 1.03.2 | . | **TYPE_IV** | empirical_family_version_inference |
| yoda_protector | 1.03.3 | . | **TYPE_IV** | empirical_family_version_inference |
...
| telock | 0.98 | `unresolved` |
| themida | 3.2.4.34 | `unresolved` |
