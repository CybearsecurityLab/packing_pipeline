...
**107 corpus definitions** · 104 typed · 3 untyped.  
*(manifest rows below: 114 typed / 0 unresolved across 114 keys; a condition named differently in packer_corpus.yaml and worklist.json appears under both, so that denominator is larger than the corpus.)*
...
| hxor_packer | 0.1 | HXOR_001_DEFAULT | **TYPE_I** | max-observed |
| hyperion | 1.2 | HYPERION_V12_001_DEFAULT | **TYPE_I** | max-observed |
| hyperion | 2.3.1 | HYPERION_001_DEFAULT | **TYPE_I** | max-observed |
...
| armadillo | 252b2 | None | **TYPE_IV** | exact |
...
| obsidium | 1.5.2.11 | None | **TYPE_VI-F** | exact |
